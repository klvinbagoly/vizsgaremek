...
| Adminként  | szeretnék bejelentkezni az oldalra | hogy tudjam szerkeszteni az adatokat. | Bejelentkezési felület egy felugeró ablakkal. |
...
| Admintként | szeretném szerkeszteni a meglévő előadókat | hogy kijavítsam/kibővítsem az előadó adatait. | Módosítás gomb (admin bejelentkezés esetén), amely átirányít az előadó szerkesztése oldalra. |
...
| Felhasználóként | szeretném látni az előadó elérhető albumait | hogy át tudjak navigálni az adott album oldalára. | Előadó legnépszerűbb albumai, amelyek klikkelésre átvisznek az album oldalára. |
